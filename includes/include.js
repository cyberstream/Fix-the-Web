...
opera.extension.onmessage = function(event) {    
    ...
    if (event.data.frame_content) {
        ...
        if (!document.getElementById('fix-the-web-comment-frame')) {
            ...
            frame_content_container.appendChild(document.createTextNode('Loading...'))
            ...
            frame_styles += '#fix-the-web-comment-frame #frame-content {font-family: "myriad pro", "arial", "lucida grande", "lucida sans unicode", "bitstream vera sans", "dejavu sans", "trebuchet ms", sans-serif; font-size: 16px; padding:20px 10px 5px 10px; font-weight:bold; color:#333;}';
