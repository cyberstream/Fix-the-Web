$(function() {        
    ...
    outputReports = function ( page_number, reports_per_page, order ) {
        ...
        $.ajax({
            url: CONFIG.defaultHost + 'ajax_request_handler.php?mode=get_report_list&order=' +order+ '&count=' + reports_per_page + '&page=' + page_number, 
            dataType: 'json',
            ...
            error: function(xhr, statusText, exception) { // error handler
                $('#recent-reports').html(i18n.error_loading_reports + ' <a href="options.html#about">' +i18n.about+ '</a>')
            }
        });
